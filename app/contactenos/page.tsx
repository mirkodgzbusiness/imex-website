...
export const metadata: Metadata = {
  title: "Contáctenos | IMEX Internacional",
  description:
    "Comunícate con nosotros por WhatsApp o visítanos en Santa Anita, Lima, Perú.",
};
            ...
            <div>
              ...
              <div className="mt-10">
                <a
                  ...
                  className="inline-flex items-center gap-3 bg-[#25D366] hover:bg-[#20ba5a] text-white font-bold px-8 py-4 rounded-full transition-colors shadow-md text-lg"
                >
